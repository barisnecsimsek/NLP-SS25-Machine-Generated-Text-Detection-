...
\begin{table}[ht]
    ...
    \textbf{Configuration} & \textbf{Accuracy} & \textbf{F1-Score} \\
    \hline
    Only RoBERTa & 0.6514 & 0.6810 \\
    
    RoBERTa + Reading Features & 0.6810 & 0.7102 \\
    
    RoBERTa + Probabilistic Features & \textbf{0.773} & \textbf{0.76} \\
    
    RoBERTa + Probabilistic Features & 0.727 & 0.72 \\ 
