...
\title{Liberta: A Hyrbid Transformer-Linguistic Model for Machine-generated Text Detection}

\author{Fabian Kobylanskyj, Bari\c{s} \c{S}im\c{s}ek, Jian Sun \and Jiwoo Lee \\Technichal University of Munich, Germany}
...
classification perfomance and yield a more robust approach than relying on a PLM alone. While RoBERTa successfully 
...
not relying on curated datasets of human written and machine-generated text. This can be particularly beneficical in 
...
probabilities computed by the model of interest, show that they can accelarate the development of more robust and 
...
Among those, there are three main groupds of methods. The first one is a fine-tuned detection, which uses a 
...
While today’s LLM’s generate grammatically correct and coherent text, their output subtly differs from human written text, 
...
log-likelihood of a sequence X: 
\[
